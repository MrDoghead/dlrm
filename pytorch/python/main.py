...
from pt2onnx import export2onnx
...
def main():
    ...
    for _ in range(5):
        ...
        """
        print('batch_dense_X',batch_dense_X.shape)
        print(batch_dense_X)
        print('batch_lS_o',batch_lS_o.shape)
        print(batch_lS_o)
        print('batch_lS_i',batch_lS_i.shape)
        print(batch_lS_i)
        sys.exit()
        """
